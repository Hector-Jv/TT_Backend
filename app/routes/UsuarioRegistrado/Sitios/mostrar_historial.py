...
mostrar_historial_bp = Blueprint('mostrar_historial', __name__)

@mostrar_historial_bp.route('/mostrar_historial/<string:correo_usuario>', methods=["GET"])
def mostrar_historial(correo_usuario):
    ...
    for sitio_objeto in sitios_encontrados:
        ...
        if not historial_encontrado or historial_encontrado.visitado == False:
            continue
