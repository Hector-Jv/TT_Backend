...
class SistemaRecomendacion():
    ...
    ## Opiniones es una lista de string ##
    
    def __init__(self, opiniones: list):
        ...
        matriz2 = []
        contadores = {}
        soporte_minimo = 5  # Este es el soporte minimo
        contador = 0
        n = 2  # Este estaba en dos, pero no recuerdo para que era
        pt = []
        # recuerda que ya hay conjuntos de dos, por esto, es 2 + total_conjuntos
        total_conjuntos = 4

        opiniones_nuevas = genera_lista(opiniones)
        print(f'Opiniones_ nuevas: {opiniones_nuevas}')
        ...
        print(f'matriz2 otra vez: {matriz2}')
        ...
        pt = []
        (regla_fuertes, contadores_fuertes) = filtro_final(
            soporte_minimo, reglas_bien, contadores_bien)
